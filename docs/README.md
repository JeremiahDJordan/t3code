...
- Provider guides: [Codex](./user/providers-codex.md) · [Claude](./user/providers-claude.md) · [OpenCode](./user/providers-opencode.md) · [Bob Shell](./user/providers-bob.md) · [Antigravity](./user/providers-antigravity.md)
